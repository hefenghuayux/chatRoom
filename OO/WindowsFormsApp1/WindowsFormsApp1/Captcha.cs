...
namespace WindowsFormsApp1
{
    internal class Captcha
    {
        ...
        private readonly float _jianju = (float)143.0;
        private readonly float _height = (float)67.0;
        ...
        public Captcha(int len, CodeType ctype)
        {
            this._len = len;
        ...
        public Stream CreateCheckCodeImage()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < 18; i++)
                {
                    ...
                    g.DrawLine(new Pen(Color.FromArgb(random.Next()), 3), x1, y1, x2, y2);
                }
                ...
                // 画图片的波形滤镜效果 
                image = TwistImage(image, true, 10, 14);
